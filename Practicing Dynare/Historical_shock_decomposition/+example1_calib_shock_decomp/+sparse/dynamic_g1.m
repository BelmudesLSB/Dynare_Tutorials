...
[T_order, T] = example1_calib_shock_decomp.sparse.dynamic_g1_tt(y, x, params, steady_state, T_order, T);
g1_v = NaN(26, 1);
g1_v(1)=(-(T(4)*exp(y(10))*getPowerDeriv(y(3),params(3),1)));
g1_v(2)=(-(1-params(4)));
g1_v(3)=(-params(2));
g1_v(4)=(-params(7));
g1_v(5)=(-params(7));
...
g1_v(15)=(-T(5));
g1_v(16)=1;
g1_v(17)=y(8)*params(5)*getPowerDeriv(y(11),1+params(6),1);
g1_v(18)=(-(T(3)*getPowerDeriv(y(11),1-params(3),1)));
