...
g1(2,9)=(-(params(1)*T(2)*(params(3)*exp(y(12))*y(10)+y(6)*(1-params(4)))));
g1(2,12)=(-(params(1)*((params(3)*exp(y(12))*y(10)+y(6)*(1-params(4)))*(-(y(5)*exp(y(9))*exp(y(12))*y(11)))/(exp(y(12))*y(11)*exp(y(12))*y(11))+T(2)*params(3)*exp(y(12))*y(10))));
g1(3,4)=1;
g1(3,1)=(-(T(4)*exp(y(7))*getPowerDeriv(y(1),params(3),1)));
g1(3,7)=(-T(5));
g1(3,8)=(-(T(3)*getPowerDeriv(y(8),1-params(3),1)));
g1(4,4)=(-exp(y(9)));
g1(4,5)=exp(y(9));
g1(4,1)=(-(1-params(4)));
g1(4,6)=1;
