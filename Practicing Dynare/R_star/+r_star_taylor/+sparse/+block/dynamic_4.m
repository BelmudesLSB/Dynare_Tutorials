...
residual=NaN(6, 1);
  ...
  residual(3)=(y(22))-(params(6)*y(6)+(1-params(6))*(y(20)*params(7)+y(26)*params(8)/4)+params(18)/400*x(1));
  residual(4)=(y(19))-(y(23)+params(1)*y(35)+params(3)*(y(26)*params(2)+y(17)*T(2)));
  residual(5)=(y(20))-(y(19)+params(5)*y(4));
